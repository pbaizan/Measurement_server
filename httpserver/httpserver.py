...
#!/usr/bin/env python
# -*- coding: utf-8 -*-
from httpserver.server import Bottle, static_file, request, response
...
class HttpServer(object):
    ...
    def Init(self):
        ...
        web.run(host=self.host, port=self.port, quiet=True, debug=True)
...
def Index():
    ClientInfo()
    return static_file("/static/aboutus.html" , root='')
